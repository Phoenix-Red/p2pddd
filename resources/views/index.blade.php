...
<div class="niwdoawi_top mw_1180">
    <div class="header w1190 clearfix">
        ...
        <div class="fr login clearfix">
            <div class="login_bt">
            @if(!Auth::user())
            <a class="fff" title="登录" rel="nofollow" href="{{url('auth/login')}}">登录</a><a class="fff" title="注册" rel="nofollow" href="{{url('auth/register')}}">注册</a>
            @else
    ...
    <a class="fl pl_20 logo_a holiday_logo" title="给梦想可能" href="#"><img height="52" alt="点点贷" src="image/logo_all.png"></a>
        ...
        <div class="fr righ">
            <ul class="nav clearfix">
                <li>
                    <a class="one" title="首页" href="/home" rel="nofollow">首页</a>
                </li>
                <li class="one">
                    <a class="{{url('')}}" title="我要投资" href="#">我要投资</a>
                </li>
                <li class="rela">
...
<div class="index_main w1180 front">
    <div class="login_front">
        ...
        <p class="fs_24 bold m">注册送10000元体验金</p>
         <span id="static_banner_login"><a title="免费注册" rel="nofollow" href="auth/register" class="btn_orange">免费注册</a><a title="马上登录" rel="nofollow" class="orange" href="auth/login">马上登录</a></span>
    </div>
</div>
                    ...
                    <div class="pro_bor">
                        <ul class="clearfix pro_list_box">
                            ...
                            <li class="w3">
                                ...
                                <p class="fc_6 airal fs_18">{{($p->recive)/100}}</p>
                            </li>
                            <li class="w4">
                                <span class="b_jingdu b_jd{{sprintf('%d',100 * $p->recive/$p->money)}}">{{sprintf('%.2f',100 * $p->recive/$p->money)}}%</span
                            </li>
                           <li class="w5">
                                <a class="btn btnSize_1 btn_orange" href="{{url('pro',[$p->pid])}}">立即投标</a>
                            </li>
                        </ul>
                    </div>
