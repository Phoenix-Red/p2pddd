        ...
        <div class="module buy_page" style="padding:0;width:100%; float:left;">
            ...
            <div class="clearfix buy_box" style="background:#fff;">
                ...
                <div class="fr r" style="width:310px;">
                	<div class="td_all2">
                    	<form action="{{url('touzi',$pro->pid)}}" method="post">
                        {!!csrf_field()!!}
                        <table width="100%" class="fc_6">
                        	<tbody>
                            <tr>
                            	<th class="fs_16 fc_9" style="text-align:left;">投资金额：</th>
                                <td style="padding-right:0;width:220px;"><input style="width:140px;" class="fc_orange airal fs_18"value="{{($pro->money - $pro->recive) / 100}}"name="money">元</td>
                            </tr>                          
                        </tbody>
                        </table>
